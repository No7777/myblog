...
class Comment(models.Model):
    ...
    status = models.IntegerField(u"状态", choices = ((1,u"普通"), (-1, u"删除")), default=1)
    
    create_timestamp = models.DateTimeField(u"回复时间", auto_now_add = True)
    ...
    def author_avatar(self):
        return UserProfile.objects.get_or_create(owner=self.owner)[0].avatar
